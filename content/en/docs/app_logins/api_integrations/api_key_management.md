...
| Type | Use |
|------|-----|
| **Admin** | Full administrative access. Use this type to call the [Admin Panel REST API](/docs/app_logins/api_integrations/rest_api/) (statistics, users, security keys, activity logs, workspace settings, etc.). |
...
- **Via API:** You can manage workspace API keys programmatically; see the [REST API](/docs/app_logins/api_integrations/rest_api/) documentation (e.g. workspace API keys endpoint) for automation.
